...
# plot 2 code
plot(new$DateTime,new$Voltage,type = "l",
...
# add legend
legend("topright",lty = 1,col = c("black","red","blue"),bty="n",cex = .6,
       pt.cex = 1,legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
